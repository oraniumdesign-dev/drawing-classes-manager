  ...
  return (
    <div dir="rtl" className="pb-28">
      ...
      <div className="bg-white px-4 pt-6 pb-5 border-b border-gray-100">
        ...
        <button className="w-full flex items-center justify-center gap-2 py-3 rounded-2xl border-2 border-gray-200 text-charcoal font-semibold text-base active:bg-gray-50">
